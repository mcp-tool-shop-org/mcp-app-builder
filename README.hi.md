...
**MCP ऐप बिल्डर** डेवलपर्स को MCP (मॉडल कॉन्टेक्स्ट प्रोटोकॉल) सर्वर को तेजी से बनाने, परीक्षण करने और तैनात करने में मदद करता है। यह नए **MCP ऐप्स** मानक (जनवरी 2026) का समर्थन करता है, जिससे कृत्रिम बुद्धिमत्ता (एआई) वार्तालापों में सीधे इंटरैक्टिव यूआई घटक जोड़े जा सकते हैं।
...
- **इंटेलिसेंस:** कॉन्फ़िगरेशन फ़ाइलों के लिए JSON स्कीमा समर्थन।

### परीक्षण।
- **परीक्षण उपकरण:** अपने एमसीपी उपकरणों के लिए परीक्षण चलाएं।
...
- **स्टेटस बार:** जब आप एमसीपी परियोजना में हों, तो एमसीपी संकेतक प्रदर्शित होता है।
...
- `full` - उपकरण, संसाधन और संकेतों के साथ एक पूर्ण सर्वर।
...
| `Ctrl+Alt+V` (मैक पर `Cmd+Alt+V`)। | स्कीमा को मान्य करें। |

## आदेश।

| आदेश। | विवरण। |
| ज़रूर, मैं आपकी मदद कर सकता हूँ। कृपया वह अंग्रेजी पाठ प्रदान करें जिसका आप हिंदी में अनुवाद करवाना चाहते हैं। | कृपया वह अंग्रेजी पाठ प्रदान करें जिसका आप हिंदी में अनुवाद करवाना चाहते हैं। |
...
| `MCP: Generate Types` | उपकरणों की परिभाषाओं से टाइपस्क्रिप्ट प्रकार (टाइप) उत्पन्न करें। |
| `MCP: Test Server` | अपने एमसीपी (MCP) उपकरणों का परीक्षण करें। |
...
वीएस कोड में, एक्सटेंशन डेवलपमेंट होस्ट को शुरू करने के लिए `F5` कुंजी दबाएं।
...
- [ ] ड्रैग-एंड-ड्रॉप यूआई (UI) घटक निर्माण उपकरण
- [ ] एमसीपी (MCP) ऐप्स का लाइव पूर्वावलोकन
- [ ] विज़ुअल फ्लो एडिटर (दृश्य प्रवाह संपादक)

## योगदान देना।

योगदानों का स्वागत है! कृपया हमारे योगदान संबंधी दिशानिर्देश पढ़ें (जल्द ही उपलब्ध होंगे)।
...
- [एमसीपी ऐप्स विनिर्देश](http://blog.modelcontextprotocol.io/posts/2026-01-26-mcp-apps/)
- [गिटहब संगठन](https://github.com/mcp-tool-shop-org)
